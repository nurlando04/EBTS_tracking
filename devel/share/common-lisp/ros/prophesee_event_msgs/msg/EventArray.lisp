...
(cl:in-package prophesee_event_msgs-msg)
...
(cl:defclass <EventArray> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (events
    :reader events
    :initarg :events
    :type (cl:vector prophesee_event_msgs-msg:Event)
   :initform (cl:make-array 0 :element-type 'prophesee_event_msgs-msg:Event :initial-element (cl:make-instance 'prophesee_event_msgs-msg:Event))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <EventArray>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'EventArray)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name prophesee_event_msgs-msg:<EventArray> is deprecated: use prophesee_event_msgs-msg:EventArray instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <EventArray>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader prophesee_event_msgs-msg:header-val is deprecated.  Use prophesee_event_msgs-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'height-val :lambda-list '(m))
(cl:defmethod height-val ((m <EventArray>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader prophesee_event_msgs-msg:height-val is deprecated.  Use prophesee_event_msgs-msg:height instead.")
  (height m))

(cl:ensure-generic-function 'width-val :lambda-list '(m))
(cl:defmethod width-val ((m <EventArray>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader prophesee_event_msgs-msg:width-val is deprecated.  Use prophesee_event_msgs-msg:width instead.")
  (width m))

(cl:ensure-generic-function 'events-val :lambda-list '(m))
(cl:defmethod events-val ((m <EventArray>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader prophesee_event_msgs-msg:events-val is deprecated.  Use prophesee_event_msgs-msg:events instead.")
  (events m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <EventArray>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'events)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'prophesee_event_msgs-msg:Event))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<EventArray>)))
  ...
  "prophesee_event_msgs/EventArray")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'EventArray)))
  "Returns string type for a message object of type 'EventArray"
  "prophesee_event_msgs/EventArray")
