...
(cl:defmethod cl:initialize-instance :after ((m <Event>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Event)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name prophesee_event_msgs-msg:<Event> is deprecated: use prophesee_event_msgs-msg:Event instead.")))

(cl:ensure-generic-function 'x-val :lambda-list '(m))
(cl:defmethod x-val ((m <Event>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader prophesee_event_msgs-msg:x-val is deprecated.  Use prophesee_event_msgs-msg:x instead.")
  (x m))

(cl:ensure-generic-function 'y-val :lambda-list '(m))
(cl:defmethod y-val ((m <Event>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader prophesee_event_msgs-msg:y-val is deprecated.  Use prophesee_event_msgs-msg:y instead.")
  (y m))

(cl:ensure-generic-function 'ts-val :lambda-list '(m))
(cl:defmethod ts-val ((m <Event>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader prophesee_event_msgs-msg:ts-val is deprecated.  Use prophesee_event_msgs-msg:ts instead.")
  (ts m))

(cl:ensure-generic-function 'polarity-val :lambda-list '(m))
(cl:defmethod polarity-val ((m <Event>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader prophesee_event_msgs-msg:polarity-val is deprecated.  Use prophesee_event_msgs-msg:polarity instead.")
  (polarity m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Event>)))
  ...
  (cl:format cl:nil "# A single event message~%uint16 x~%uint16 y~%time ts~%bool polarity~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Event)))
  "Returns full string definition for message of type 'Event"
  (cl:format cl:nil "# A single event message~%uint16 x~%uint16 y~%time ts~%bool polarity~%~%~%"))
