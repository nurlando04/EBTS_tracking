...
"""autogenerated by genpy from prophesee_event_msgs/EventArray.msg. Do not edit."""
import codecs
import sys
...
"""
  ...
  _slot_types = ['std_msgs/Header','uint32','uint32','prophesee_event_msgs/Event[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = prophesee_event_msgs.msg.Event()
        _x = val1
        start = end
        end += 4
